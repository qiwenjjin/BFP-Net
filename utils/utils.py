...
def divide_amp_pha(img):
    '''
    divide amplitude and phase component of ff
    '''
    var_ff = torch.fft.rfft2(img + 1e-8, norm='backward')
    var_amp = torch.abs(var_ff)
    var_pha = torch.angle(var_ff)

    return var_amp, var_pha